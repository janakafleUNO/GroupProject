...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        user = "WronguserId"  # must be a valid username for the application
        pwd = "Wrongpassword"  # must be the password for a valid user
        ...
        try:
            ...
            print("Test Passed - InValid user and Invalid password used")
            assert True
